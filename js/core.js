...
const getHiddenCard = (numCard, blureCount = 4) => {
  const blure = ('*'.repeat(blureCount));
  const card = numCard.replace(numCard.slice(0, 12), blure);
  console.log(card);
}

getHiddenCard('1234123412344321');
